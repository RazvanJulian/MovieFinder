...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        popularNavigationController.tabBarItem.image = UIImage(named: "play-button")
        
        let searchNavigationController = storyboard.instantiateViewController(withIdentifier: "moviesNavigationController") as! UINavigationController
        ...
        searchNavigationController.tabBarItem.image = UIImage(named: "search-button")
        
        let tabBarController = UITabBarController()
        tabBarController.viewControllers = [popularNavigationController, searchNavigationController]
        ...
        UITabBar.appearance().barTintColor = UIColor.darkText
